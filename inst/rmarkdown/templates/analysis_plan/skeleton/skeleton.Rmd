...
Assuming the data are tidy and clean, we estimate <mark>4-6 days of analysis time</mark> (at $875 per day, excluding GST), which does not include final result preparation time. Up to two Biometrics Biostatisticians to be included as authors on resulting publication(s) (assuming sufficient academic contributions are made).
