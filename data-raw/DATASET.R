...
clean_REDCap_validation <- tibble(id1 = as.character(1:2),
                                  ...
                                  date_mdy1 = rep(mdy("02/16/1985"), 2),
                                  date_ymd1 = rep(ymd("1985/02/16"), 2),
                                  datetime_dmy1 = c(dmy_hm("16/02/1985 12:01 AM"), dmy_hm("16/02/1985 12:01 PM")),
                                  datetime_mdy1 = c(mdy_hm("02/16/1985 12:01 AM"), mdy_hm("02/16/1985 12:01 PM")),
                                  datetime_ymd1 = c(ymd_hm("1985/02/16 12:01 AM"), ymd_hm("1985/02/16 12:01 PM")),
                                  datetime_seconds_dmy1 = c(dmy_hms("16/02/1985 12:01:01 AM"), dmy_hms("16/02/1985 12:01:01 PM")),
                                  datetime_seconds_mdy1 = c(mdy_hms("02/16/1985 12:01:01 AM"), mdy_hms("02/16/1985 12:01:01 PM")),
                                  datetime_seconds_ymd1 = c(ymd_hms("1985/02/16 12:01:01 AM"), ymd_hms("1985/02/16 12:01:01 PM")),
                                  integer1 = rep(1L, 2),
                                  number1 = rep(1.5, 2),
